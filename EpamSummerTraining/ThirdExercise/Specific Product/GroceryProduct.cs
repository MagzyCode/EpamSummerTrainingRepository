...
namespace SecondTask.ThirdExercise.Specific_Product
{
    ...
    public class GroceryProduct : Product
    {
        ...
        {
            var result = GetConvertedProduct<BiochemicalProduct, GroceryProduct>(product);
            return result;
        }

        public static implicit operator HouseholdProduct(GroceryProduct product)
        {
            var result = GetConvertedProduct<HouseholdProduct, GroceryProduct>(product);
            return result;
        }

        public static implicit operator GastronomicProduct(GroceryProduct product)
        {
            var result = GetConvertedProduct<GastronomicProduct, GroceryProduct>(product);
            return result;
        }
